      ...
      <div className="bg-gradient-to-r from-purple-50 to-purple-100 py-16">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center mb-8">
            <Icon className="w-12 h-12 text-purple-600 mr-4" />
              ...
              <div className="space-y-4">
                {section.items.map((item, i) => (
                  <div className="flex items-start" key={i}>
                    {item.icon && <item.icon className="w-6 h-6 text-purple-600 mt-1 mr-3" />}
                    <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {area.bestPractices.map((bp, i) => (
                <div className="bg-white rounded-lg p-6" key={i}>
                  <h3 className="font-semibold text-lg mb-3 text-purple-600">{bp.heading}</h3>
...
export default SpecializedAreaDetail;
